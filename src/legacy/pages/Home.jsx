...
const Home = () => {
  ...
  const testimonials = [
    ...
    },
    {
      rating: 4,
      quote:
        "I joined The Essentials of Self-Discovery course mainly out of curiosity, but I ended up connecting with myself on a whole new level. The way Panchang was broken down made it feel so relevant to everyday life. The course gave me a beautiful foundation in astrology without ever feeling overwhelming.",
      name: "Malvi Vashi",
      title: "The Essentials of Self-Discovery (Panchang and Basic Astrology)",
    },
    {
    ...
    },
    {
      rating: 5,
      quote:
        "I had no background in astrology before joining The Essentials of Self-Discovery (Panchang and Basic Astrology), but the course made me feel comfortable from the start. Every topic felt relevant, and I loved how the Panchang concepts were explained with real-life examples. It has become part of how I approach my days now.",
    ...
    <div className="pt-0 bg-transparent min-h-screen text-sm ">
      ...
      <Link to={"/articles"}>
        <marquee
          behavior="scroll"
          direction="left"
          className="text-red-600 bg-orange-100"
        >
          {data.length > 0
        ...
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between px-6 lg:px-20">
          ...
          <div className=" bg-white mt-3 lg:w-1/2 text-center lg:text-left space-y-6 ">
            <p className="text-base md:text-2xl font-bold text-red-600 leading-tight">
              Leads your life from Darkness to Light With{" "}
              <strong className="  text-xl md:text-4xl"> Vahlay Astro</strong>{" "}
              ...
            </p>
            <p className="text-gray-700  ">
              Welcome to...<strong> Vahlay Astro</strong>, your trusted source
              for astrology education and expert guidance. Whether you're just
              starting your journey into the world of astrology or looking to
              deepen your knowledge, our courses and support services are
              designed to help you understand the cosmic forces that influence
              your life. Join our community of passionate learners and unlock
          ...
          <div className="lg:w-1/2 flex justify-center  lg:justify-end opacity-80">
            <img
              src="https://res.cloudinary.com/dzdnwpocf/image/upload/v1753466276/new_wheel_s5ozry.png" // Replace with the correct image path
              alt="Astrology Chart"
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 px-6 lg:py-12 bg-white  ">
        ...
        <div className="lg:w-1/4 ">
          <img
            src="https://res.cloudinary.com/dzdnwpocf/image/upload/v1753466267/About-us-hp_nu7vwu.webp" // Replace with your actual image path
            alt="Astrology"
        ...
        <div className="lg:w-3/4 text-center lg:text-left ">
          ...
          <p className="text-gray-700 mb-6">
            ...<strong> Vahlay Astro</strong> was founded with the mission to
            bring the ancient wisdom of astrology into the modern world. Our
            experienced astrologers guide individuals and businesses through
            life’s most significant decisions, helping them connect deeply with
            the universe and understand the cycles of nature
          </p>
          <p className="text-gray-700 mb-6">
            We believe astrology empowers individuals by providing clarity and
            insight. Rooted in Vedic astrology, our approach is designed to meet
            the needs of today’s world, offering personalized support for
          ...
          {data.map((article, index) => (
            <SwiperSlide key={index} className="mb-6">
              <Link to={`/article/${article.slug}`}>
                <div
                  className="w-full p-4 bg-red-100 shadow-md rounded-xl border border-gray-300 hover:shadow-lg hover:-translate-y-1 transform 
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl ">
          ...
          <p className=" text-sm lg:text-lg text-gray-300 mb-8">
            ...
            guidance from our expert astrologers. Whether you’re seeking clarity
            on a specific life decision, curious about your birth chart, or
            looking for support during a challenging time, our consultations are
            designed to provide insight and direction.
          </p>
      ...
      <div className="bg-gray-50 py-6  md:py-16 px-6 lg:px-20 flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-3/4  my-10  lg:my-auto lg:pr-10 ">
          ...
          <p className="text-gray-700 text-center lg:text-left text-sm lg:text-lg leading-relaxed mb-6">
            At...<strong> Vahlay Astro</strong>, we provide expert astrology
            consulting to guide you through life’s most pivotal decisions. Our
            personalized consultations offer deep insights into your birth
            chart, relationships, career, and life purpose, helping you navigate
            challenges and seize opportunities. With a focus on Vedic astrology,
            we empower you with actionable remedies and cosmic guidance to align
            with your true path. Our mission is to bring clarity, balance, and
            purpose to your journey, enabling you to make informed decisions and
        ...
        <div className="lg:w-3/12">
          <img
            src="https://res.cloudinary.com/dzdnwpocf/image/upload/v1753466300/what-we-do-hp_xf5eqq.webp" // Replace with your image path
                    ...
                    >
                      ...
                      >
                        {Array.from({ length: testimonial.rating }).map(
                          (_, i) => (
                            <span className="font-extrabold text-lg" key={i}>
                              &#9733;
                            </span>
                          )
                        )}
      ...
      <div className="flex flex-col items-center justify-center min-h-auto bg-linear-to-br from-red-500 via-red-600 to-red-700 p-8">
        {/* Header */}
        ...
        {isMobile ? (
            ...
            {partners.map((partner, index) => (
              <SwiperSlide key={index}>
                <div className="relative flex flex-col items-center bg-white p-2 mb-8 rounded-3xl shadow-lg transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl">
                  <div className="absolute inset-0 w-full h-full bg-linear-to-tr from-red-400 via-red-500 to-red-600 blur-3xl opacity-20 rounded-3xl -z-10"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-12 w-full max-w-7xl">
            {partners.map((partner, index) => (
              <div
                key={index}
                className="relative flex flex-col items-center bg-white p-8 rounded-3xl shadow-lg transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl"
              >
                <div className="absolute inset-0 w-full h-full bg-linear-to-tr from-red-400 via-red-500 to-red-600 blur-3xl opacity-20 rounded-3xl -z-10"></div>
                <div className="w-48 h-48 flex items-center justify-center bg-gray-100 border-4 border-red-500 rounded-full overflow-hidden transform hover:scale-110 transition-transform duration-300">
                  <img
