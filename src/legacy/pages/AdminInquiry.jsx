          ...
          <div className="space-y-8">
            ...
            {loading ? (
              ...
              <div className="text-center py-24 bg-white border border-slate-100 rounded-2xl shadow-sm">
                <p className="text-slate-400 font-medium italic">No inquiries found matching your criteria.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-8 flex flex-col h-full">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-6">
                        ...
                        <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                          ...
                          <p className="text-[13px] text-slate-700 font-medium">{inquiry.phone || 'N/A'}</p>
                        </div>
                      </div>
