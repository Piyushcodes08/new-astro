        ...
        <>
            ...
            <main className="min-h-screen relative z-10 text-white overflow-hidden bg-transparent">
                ...
                <section>
                    ...
                    <div className="section-container">
                        <div className="bg-linear-to-br from-brand-red/20 to-black border border-brand-red/30 rounded-xl py-16 md:py-24 px-[15px] md:px-[50px] text-center shadow-[0_30px_100px_rgba(221,39,39,0.25)] relative overflow-hidden group">
