                ...
                <section>
                    <div className="section-container">
                        <div className="bg-gradient-to-r from-[#dd2727]/90 to-orange-500/80 backdrop-blur-xl border border-white/10 rounded-xl p-8 md:p-16 max-w-4xl mx-auto shadow-[0_15px_60px_rgba(221,39,39,0.35)] text-center">
                            ...
                            <Link to="/contact" className="inline-block bg-white/10 backdrop-blur-lg border border-white/20 text-white px-8 py-3 rounded-full font-bold uppercase tracking-wider transition-all duration-500 hover:bg-white hover:text-[#dd2727] text-sm md:text-base">
